...
export function PublicHeader({ brand }: { brand: BrandSettings }) {
  return (
    <header className="sticky top-0 z-40 border-b border-champagne/30 bg-ivory/92 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-5 py-4 lg:px-8">
        ...
        <nav className="hidden items-center gap-6 text-[13px] font-medium uppercase tracking-[0.16em] text-espresso/75 lg:flex">
        ...
        <Link
          ...
          className="border border-champagne bg-champagne px-5 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-white transition hover:bg-espresso"
        >
          Book
        </Link>
      </div>
