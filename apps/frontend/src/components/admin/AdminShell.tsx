...
import { Bell, CalendarDays, FileText, GalleryHorizontalEnd, HelpCircle, Images, Inbox, LayoutDashboard, Link2, LogOut, MessageSquareQuote, Palette, Sparkles, SquarePen, Tags, Users, View } from "lucide-react";
...
const navItems = [
  ...
  { label: "Notifications", href: "/admin/notification-campaigns", icon: Bell },
